...
if ($relativa !== '') {
    ...
    echo "<p class='text-muted mt-2 mb-2'>No se permite subir archivos en esta carpeta. Cree una subcarpeta para organizar archivos.</p>";
                            ...
                            echo "
            <form action='" . route('crea.tecnica.crearCarpeta', $codigo_serviu) . "' method='POST' class='mb-3'>
                " . csrf_field() . "
                ...
                <div class='input-group'>
                    ...
                    <button type='submit' class='btn btn-sm btn-outline-secondary'>Crear carpeta</button>
                            ...
                            if ($relativa !=='' ) {
                            echo "
                <form action='" . route('crea.tecnica.eliminarCarpeta', $codigo_serviu) . "' method='POST' onsubmit='return confirm(\" ¿Estás seguro que deseas eliminar esta carpeta y todo su contenido?\")' class='mb-3'>
                        ...
                        echo "<ul>";
                            ...
                            echo "<li>
                                ...
                                <form action='" . route('crea.tecnica.eliminarArchivo', $codigo_serviu) . "' method='POST' style='display:inline-block; margin-left: 10px;' onsubmit='return confirm(\" ¿Seguro que deseas eliminar este archivo?\")'>
                                    " . csrf_field() . method_field('DELETE') . "
        ...
        <div class="mt-4">
            <a href="{{ route('crea.tecnica.index') }}" class="btn btn-secondary">← Volver</a>
        </div>
    </div>
</section>
@endsection