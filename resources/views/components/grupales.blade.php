            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @php
                            $rutaBase = "$portal/Antecedentes Grupales/$codigo";
                        @endphp
                        <details class="mb-4 border rounded p-3">
                            ...
                            <form action="{{ route("$portal.serviu.upload", $codigo) }}" method="POST" enctype="multipart/form-data" class="mb-3">
                                @csrf
                                <div class="row align-items-end">
                                    <div class="col-md-4">
                                        ...
                                        @php $rutaCarta = "$rutaBase/Carta_de_Compromiso.pdf"; @endphp
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @php $rutaContrato = "$rutaBase/Contrato_de_Construccion.pdf"; @endphp
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    @if (Storage::disk('public')->exists($rutaCarta))
                                    <form action="{{ route("$portal.serviu.eliminar", ['codigo' => $codigo, 'tipo' => 'Carta_de_Compromiso']) }}" method="POST">
                                        @csrf @method('DELETE')
                                ...
                                <div class="col-md-4">
                                    @if (Storage::disk('public')->exists($rutaContrato))
                                    <form action="{{ route("$portal.serviu.eliminar", ['codigo' => $codigo, 'tipo' => 'Contrato_de_Construccion']) }}" method="POST">
                                        @csrf @method('DELETE')
                            ...
                            <table class="table table-striped mt-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('ver-individuo')
                                            <a class="btn btn-info btn-sm" href="{{ route("$portal.individuos.show", $individuo->id) }}">
                                                Ver Detalle
                                            </a>
                                            @endcan
                                        </td>
