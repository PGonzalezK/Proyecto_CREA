            ...
            <div class="col-lg-10">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <form method="GET" action="{{ route('edifica.tecnica.index') }}" class="d-flex">
                        ...
                        @else
                            <div class="list-group">
                                @foreach($paginados as $codigo => $grupo)
                                    <a href="{{ route('edifica.tecnica.show', $codigo) }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
