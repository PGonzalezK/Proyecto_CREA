            ...
            <div class="bg-image" style="">
                <div class="bg-primary-op">
                    <div class="content-header">
                        <!-- User Avatar -->
                        <!-- Layout dinámico del avatar -->
                        <a class="img-link mr-1" href="{{ route('perfil.show') }}">
                            <img class="img-avatar img-avatar48" src="{{ Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : asset('') }}" alt="">
                        </a>
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('inicio') ? ' active' : '' }}" href="/inicio">
                        ...
                        <li class="nav-main-item{{ request()->is('seccion/*') ? ' open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('seccion/personas') ? ' active' : '' }}" href="/seccion/personas">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('seccion/cuentas') ? ' active' : '' }}" href="/seccion/cuentas">
                                        <span class="nav-main-link-name">Gestion de cuentas</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div class="dropdown-menu dropdown-menu-right p-0" aria-labelledby="page-header-user-dropdown">
                            ...
                            <div class="p-2">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)" data-toggle="layout" data-action="side_overlay_toggle">
                                    <i class="far fa-fw fa-building mr-1"></i> Configuracion
                                </a>
                                <!-- END Side Overlay -->
