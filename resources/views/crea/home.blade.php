                        ...
                        <div class="row">
                            <div class="col-md-4 col-xl-4">
                                <div class="card bg-c-blue order-card">
                                    <div class="card-block">
                                        ...
                                        <p class="m-b-0 text-right"><a href="/crea/usuarios" class="text-white">Ver más</a></p>
                                    </div>                                            
                                </div>                                    
                            </div>
                            ...
                            <div class="col-md-4 col-xl-4">
                                <div class="card bg-c-green order-card">
                                    <div class="card-block">
                                        ...
                                        <p class="m-b-0 text-right"><a href="/crea/roles" class="text-white">Ver más</a></p>
                                    </div>
                                </div>
                            </div>                                                                
                            ...
                            <div class="col-md-4 col-xl-4">
                                <div class="card bg-primary text-white order-card">
                                    <div class="card-block">
                                        <h5>Individuos CREA</h5>
                                        @php
                                            use App\Models\Individuo;
                                            $cant_individuos_crea = Individuo::where('id_empresa', 1)->count();
                                        @endphp
                                        <h2 class="text-right"><i class="fa fa-user f-left"></i><span>{{ $cant_individuos_crea }}</span></h2>
                                        <p class="m-b-0 text-right">
                                            <a href="/crea/individuos" class="text-white">Ver más</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach($individuosPorVencer as $individuo)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('crea.individuos.show', $individuo->id) }}" class="btn btn-sm btn-primary">Ver</a>
                                                    <a href="{{ route('crea.individuos.edit', $individuo->id) }}" class="btn btn-sm btn-warning">Editar</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
